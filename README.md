...
#### **F5 BIG-IP Firewall Families and Models**

The F5 BIG-IP Firewall families and models are listed in the following table:

|Family|Model|Description|
|:---|:---|:---|
|CS_ Firewall|F5 Big IP Firewall Shell 2G|Generic F5 Big IP Firewall Shell 2 Generation|
...
1. Download the *cloudshell-firewall-f5-big-ip-2-gen-dependencies-package-1.0.0.zip* file, see [Downloading the Shell](#downloading-the-shell).
...
3. Enter the following parameters:
    * **Path** (mandatory): Enter the full path of the firmware file on the remote host. For example, *tftp://10.1.1.1/BIG-IPv11.x*. 
